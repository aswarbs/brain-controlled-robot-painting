...
class RobotCommands():
    ...
    def perform_movement(self, rotations, plan_joints):
        ...
        if(alpha_rotation >= -pi/8 and alpha_rotation <= pi/8):
    ...
    def handle_buffer(self, plan_joints):

        path = os.path.normpath(os.getcwd() + os.sep + os.pardir)

        with open(path + '/CSVs/amber.csv', 'r') as file:    
    ...
    def calculatePSD(self, buffer):
                ...
                print(max_alpha, max_beta, max_theta)
